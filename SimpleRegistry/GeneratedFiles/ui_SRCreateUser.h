...
public:
    ...
    void setupUi(QWidget *SRCreateUser)
    {
        ...
        formLayoutWidget->setGeometry(QRect(0, 0, 461, 311));
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, label_var1);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, textEdit_var1);

        label_var2 = new QLabel(formLayoutWidget);
        label_var2->setObjectName(QString::fromUtf8("label_var2"));
        label_var2->setFont(font);

        formLayout->setWidget(4, QFormLayout::LabelRole, label_var2);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, textEdit_var2);

        label_var3 = new QLabel(formLayoutWidget);
        label_var3->setObjectName(QString::fromUtf8("label_var3"));
        label_var3->setFont(font);

        formLayout->setWidget(5, QFormLayout::LabelRole, label_var3);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, textEdit_var3);

        label_var4 = new QLabel(formLayoutWidget);
        label_var4->setObjectName(QString::fromUtf8("label_var4"));
        label_var4->setFont(font);

        formLayout->setWidget(6, QFormLayout::LabelRole, label_var4);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, textEdit_var4);
